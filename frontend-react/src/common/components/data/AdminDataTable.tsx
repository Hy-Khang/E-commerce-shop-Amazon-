        ...
        {showPageSize && (
          <label className="flex items-center gap-1.5 text-sm text-slate-500">
            ...
            <select
              ...
              className="rounded-lg border border-slate-200 bg-white py-1 pl-2 pr-7 text-sm text-slate-700 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 focus:outline-none transition-colors"
