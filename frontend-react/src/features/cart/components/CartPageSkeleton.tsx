export function CartPageSkeleton() {
  return (
    <div className="animate-pulse">
      <div className="mb-6 h-8 w-48 rounded bg-neutral-200 dark:bg-neutral-700" />
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-border-default bg-surface p-4">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex items-center gap-4 border-b border-border-default py-4 last:border-b-0">
                <div className="h-20 w-20 rounded-lg bg-neutral-200 dark:bg-neutral-700" />
        ...
        <div>
          <div className="rounded-xl border border-border-default bg-surface p-6">
            ...
            <div className="mt-6 h-12 w-full rounded bg-neutral-200 dark:bg-neutral-700" />
          </div>
        </div>
      </div>
    </div>
