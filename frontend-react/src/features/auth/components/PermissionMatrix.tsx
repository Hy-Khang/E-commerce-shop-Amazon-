...
function getActionColor(action: string) {
  return ACTION_COLORS[action] ?? { bg: 'bg-gray-50', text: 'text-gray-700', dot: 'bg-gray-400' };
}
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full border-collapse">
        <thead>
          <tr>
            <th className="sticky left-0 z-10 min-w-[260px] border-b-2 border-gray-200 bg-gray-50 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">
              Resource / Action
            </th>
            {roles.map((role) => (
              <th
                key={role.id}
                className="min-w-[120px] border-b-2 border-gray-200 bg-gray-50 px-3 py-3 text-center"
              >
...
function ResourceGroup({
  ...
  return (
    <>
      <tr
        className="group cursor-pointer select-none border-t border-gray-100 hover:bg-gray-50/80"
        onClick={onToggleCollapse}
      >
        <td className="sticky left-0 z-10 bg-white px-4 py-3 group-hover:bg-gray-50/80">
          <div className="flex items-center gap-3">
            ...
            <div className="ml-auto text-gray-400 transition-transform">
      ...
      {!isCollapsed &&
        sortedPermissions.map((permission) => {
          ...
          return (
            ...
            >
              <td className="sticky left-0 z-10 bg-white py-2.5 pl-16 pr-4 hover:bg-gray-50/50">
