...
export class AddDeliveredAtAndMigrateStatuses1749300006000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE orders ADD delivered_at DATETIME2 NULL`);
    await queryRunner.query(`CREATE INDEX idx_orders_delivered_at ON orders (delivered_at)`);
