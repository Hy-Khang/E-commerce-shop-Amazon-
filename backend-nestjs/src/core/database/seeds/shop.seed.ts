  ...
  async run(ds: DataSource) {
    ...
    await qr.query(`
      ...
      INSERT INTO shops (id, user_id, name, slug, description, logo_url, banner_url, status, verified_at) VALUES
        (1, 6,  N'Shop Thời Trang Hằng', N'shop-thoi-trang-hang',
        ...
        (2, 8,  N'TechZone VN', N'techzone-vn',
        ...
        (3, 9,  N'Mai''s Home & Living', N'mais-home-living',
        ...
        (5, 11, N'Hùng Style', N'hung-style',
        ...
        (6, 12, N'Lan Accessories', N'lan-accessories',
        ...
        (7, 13, N'Sơn Sneakers', N'son-sneakers',
