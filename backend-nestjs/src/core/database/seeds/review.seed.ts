  ...
  async run(ds: DataSource) {
    ...
    await qr.query(`
      ...
      INSERT INTO reviews (id, user_id, product_id, order_id, rating, comment, created_at) VALUES
        ...
        (8,  6,  2,  6,  4, N'Áo oversize form đẹp, vải mềm. Size hơi rộng so với mô tả.',                  '2026-04-01T14:30:00'),
        (9,  6,  6,  6,  5, N'Giày sneaker đi rất êm, màu trắng dễ phối đồ.',                               '2026-04-01T14:35:00'),
        -- Order 7 (March 30, user 7, delivered): product 9
        (10, 7,  9,  7,  5, N'Samsung camera zoom 100x quá đỉnh. Màn hình sáng đẹp.',                       '2026-04-05T11:20:00'),
        -- Order 8 (April 3, user 8, delivered): product 15
        (11, 8,  15, 8,  4, N'Ghế ngồi thoải mái, tựa đầu điều chỉnh được. Lắp ráp hơi khó.',              '2026-04-10T09:45:00'),
        ...
        (16, 6,  18, 13, 5, N'Đọc lại lần 2 vẫn thấy hay. Classic không bao giờ lỗi thời.',                 '2026-05-04T17:30:00'),
        -- Order 14 (May 2, user 7, delivered): product 4
        (17, 7,  4,  14, 4, N'Quần jean co giãn tốt, dáng slim vừa vặn.',                                   '2026-05-08T10:15:00'),
        -- Order 15 (May 7, user 8, delivered): product 11
        (18, 8,  11, 15, 5, N'ThinkPad bàn phím gõ sướng nhất, bền bỉ. Business laptop number 1.',          '2026-05-13T15:45:00'),
