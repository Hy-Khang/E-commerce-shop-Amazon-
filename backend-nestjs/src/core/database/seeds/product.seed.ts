...
export const ProductSeed: ISeed = {
  ...
  async run(ds: DataSource) {
    ...
    await qr.query(`
      ...
      INSERT INTO products (id, category_id, name, slug, description, thumbnail_url, option1_label, option2_label, is_active) VALUES
        (1,  15, N'Áo thun nam basic cotton',       N'ao-thun-nam-basic-cotton',       N'Áo thun nam chất liệu cotton 100%, thoáng mát',           N'https://picsum.photos/seed/ao-thun-basic/400/400',    N'Màu sắc',    N'Kích thước', 1),
        (2,  15, N'Áo thun nam oversize',            N'ao-thun-nam-oversize',            N'Áo thun form rộng phong cách Hàn Quốc',                    N'https://picsum.photos/seed/ao-thun-oversize/400/400', N'Màu sắc',    N'Kích thước', 1),
        (3,  16, N'Áo sơ mi nam Oxford',             N'ao-so-mi-nam-oxford',             N'Áo sơ mi Oxford dáng slim fit, vải dày dặn',               N'https://picsum.photos/seed/ao-so-mi-oxford/400/400',  N'Màu sắc',    N'Kích thước', 1),
        (4,  6,  N'Quần jean nam slim fit',          N'quan-jean-nam-slim-fit',          N'Quần jean co giãn, dáng ôm vừa phải',                      N'https://picsum.photos/seed/quan-jean-slim/400/400',   N'Màu sắc',    N'Kích thước', 1),
        (5,  6,  N'Quần kaki nam',                   N'quan-kaki-nam',                   N'Quần kaki nam form regular, vải mềm',                       N'https://picsum.photos/seed/quan-kaki/400/400',        N'Màu sắc',    N'Kích thước', 1),
        (6,  7,  N'Giày sneaker trắng',              N'giay-sneaker-trang',              N'Giày sneaker trắng basic, đế cao su bền',                   N'https://picsum.photos/seed/sneaker-trang/400/400',    N'Kích thước', NULL,          1),
        (7,  7,  N'Dép quai ngang nam',              N'dep-quai-ngang-nam',              N'Dép quai ngang êm chân, phù hợp đi hàng ngày',             N'https://picsum.photos/seed/dep-quai-ngang/400/400',   N'Kích thước', NULL,          1),
        (8,  8,  N'iPhone 15 Pro Max',               N'iphone-15-pro-max',               N'iPhone 15 Pro Max chip A17 Pro, camera 48MP',                N'https://picsum.photos/seed/iphone-15-promax/400/400', N'Dung lượng', N'Màu',        1),
        (9,  8,  N'Samsung Galaxy S24 Ultra',        N'samsung-galaxy-s24-ultra',        N'Samsung Galaxy S24 Ultra, S Pen tích hợp',                  N'https://picsum.photos/seed/samsung-s24/400/400',      N'Dung lượng', N'Màu',        1),
        (10, 9,  N'MacBook Air M3',                  N'macbook-air-m3',                  N'MacBook Air chip M3, 15.3 inch Liquid Retina',              N'https://picsum.photos/seed/macbook-air-m3/400/400',   N'Dung lượng', N'Màu',        1),
        (11, 9,  N'Lenovo ThinkPad X1 Carbon',       N'lenovo-thinkpad-x1-carbon',       N'ThinkPad X1 Carbon Gen 12, Core Ultra 7',                   N'https://picsum.photos/seed/thinkpad-x1/400/400',      NULL,          NULL,          1),
        (12, 10, N'Tai nghe AirPods Pro 2',          N'tai-nghe-airpods-pro-2',          N'AirPods Pro 2 USB-C, chống ồn chủ động',                   N'https://picsum.photos/seed/airpods-pro-2/400/400',    NULL,          NULL,          1),
        (13, 10, N'Sạc nhanh 65W GaN',              N'sac-nhanh-65w-gan',              N'Sạc nhanh 65W GaN, 3 cổng, gọn nhẹ',                       N'https://picsum.photos/seed/sac-65w-gan/400/400',      NULL,          NULL,          1),
        (14, 11, N'Bàn làm việc gỗ tự nhiên',       N'ban-lam-viec-go-tu-nhien',       N'Bàn làm việc gỗ sồi, kích thước 120x60cm',                 N'https://picsum.photos/seed/ban-lam-viec/400/400',     N'Màu sắc',    NULL,          1),
        (15, 11, N'Ghế công thái học',               N'ghe-cong-thai-hoc',               N'Ghế ergonomic có tựa đầu, tay vịn điều chỉnh',             N'https://picsum.photos/seed/ghe-ergonomic/400/400',    N'Màu sắc',    NULL,          1),
        (16, 12, N'Nồi chiên không dầu 5L',         N'noi-chien-khong-dau-5l',         N'Air fryer 5 lít, 8 chế độ nấu, màn hình cảm ứng',         N'https://picsum.photos/seed/air-fryer/400/400',         NULL,          NULL,          1),
        (17, 12, N'Bộ dao nhà bếp 6 món',           N'bo-dao-nha-bep-6-mon',           N'Bộ dao thép không gỉ kèm block gỗ',                        N'https://picsum.photos/seed/bo-dao/400/400',            NULL,          NULL,          1),
        (18, 13, N'Đắc Nhân Tâm',                   N'dac-nhan-tam',                   N'Dale Carnegie - Nghệ thuật ứng xử và giao tiếp',           N'https://picsum.photos/seed/dac-nhan-tam/400/400',     NULL,          NULL,          1),
        (19, 13, N'Atomic Habits',                   N'atomic-habits',                   N'James Clear - Thay đổi tí hon, hiệu quả bất ngờ',          N'https://picsum.photos/seed/atomic-habits/400/400',    NULL,          NULL,          1),
        (20, 14, N'Nhà Giả Kim',                    N'nha-gia-kim',                    N'Paulo Coelho - Tiểu thuyết triết lý nổi tiếng thế giới',   N'https://picsum.photos/seed/nha-gia-kim/400/400',      NULL,          NULL,          1);
