...
// This stub mirrors the real PermissionsGuard for the test's purpose: admin
// holds every permission, any other role is denied on a permissioned route;
// unpermissioned routes pass through.
